...
})({"dk48p":[function(require,module,exports,__globalThis) {
...
},{}],"8R4wl":[function(require,module,exports,__globalThis) {
// Task.ts: Representa uma única tarefa
class Task {
    constructor(id, title, description, dueDate, status = "pendente" // Status inicial da tarefa
    ){
        this.id = id;
        this.title = title;
...
class TaskRepository {
    ...
    constructor(){
        this.tasks = [] // Lista de tarefas armazenadas
        ;
    }
}
...
class TaskService {
     ...
     */ criarTarefa(title, description, dueDate) {
        const task = new Task(Date.now(), title, description, dueDate);
     ...
     */ concluirTarefa(id) {
        ...
        if (task) task.alterarStatus("conclu\xedda");
    }
    /**
...
class TaskManager {
    ...
    constructor(){
        ...
        this.taskView = new TaskView(this.taskService);
    }
}
...
},{}]},["dk48p","8R4wl"], "8R4wl", "parcelRequire94c2")
